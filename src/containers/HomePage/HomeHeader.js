                    ...
                    <div className="home-header-content">
                        <div className="left-content">
                            ...
                            >
                                ...
                                >
                                    <path
                                        d="M73.11 41.43a31.68 31.68 0 1 0 31.68 31.68 31.68 31.68 0 0 0-31.68-31.68Zm19.9 38H79.43v13.65H66.78V79.43H53.21V66.78h13.57V53.13h12.65v13.65H93Z"
                                        className="bookingcare-2020_svg__cls-1"
                                    ></path>
                                    <path
                                        d="M73.11 125.24A52.13 52.13 0 0 1 21 74.49V21.88a73.09 73.09 0 1 0 107.67 98.74L112.71 107a52 52 0 0 1-39.6 18.24ZM73.11 0A72.82 72.82 0 0 0 44.3 5.91l-.3.15a3.76 3.76 0 0 0-2.13 3.37v22A52.14 52.14 0 0 1 113.36 40l16.19-13.33A73 73 0 0 0 73.11 0Z"
                                        className="bookingcare-2020_svg__cls-1"
                                    ></path>
                                    <path
